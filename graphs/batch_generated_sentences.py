...
fig["layout"]["yaxis1"].update(type="log", autorange=True)
fig["layout"]["yaxis2"].update(type="log", autorange=True)
fig["layout"]["yaxis3"].update(title=y_axis_label, type="log", autorange=True)
fig["layout"]["yaxis4"].update(title=y_axis_label, type="log", autorange=True)
fig["layout"]["yaxis5"].update(type="log", autorange=True)
fig["layout"]["yaxis6"].update(type="log", autorange=True)
